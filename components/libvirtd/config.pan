...
'/software/packages'=pkg_repl('ncm-libvirtd','1.4-1','noarch');
...
"/software/components/filecopy/services" = npush(
	escape("/etc/libvirt/qemu.conf"),
	nlist("config",QEMU_CONF,
		"owner","root",
		"group","root",
		"perms","0644",
