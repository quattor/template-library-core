################################################################################
# This is 'TPL/config.tpl', a ncm-squid's file
################################################################################
#
# VERSION:    0.3.5, 07/02/11 19:53
# AUTHOR:     Marco Emilio Poleggi <Marco.Poleggi@cern.ch>
# MAINTAINER: Marco Emilio Poleggi <Marco.Poleggi@cern.ch>
...
# Package to install
"/software/packages"=pkg_repl("ncm-squid","0.3.5-1","noarch");
