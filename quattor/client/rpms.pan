...
variable QUATTOR_RELEASE ?= '13.1-rc0';
variable QUATTOR_PACKAGES_VERSION ?= '13.3.0-1';

# Quattor services.
"/software/packages"=pkg_repl("ccm","13.3.1-SNAPSHOT20130403170204","noarch");
"/software/packages"=pkg_repl("cdp-listend","13.1"+"-SNAPSHOT20130401210216","noarch");
"/software/packages"=pkg_repl("spma","2.1.1-1","noarch");
"/software/packages"=pkg_repl("rpmt-py","1.2.1-1","noarch");

# NCM components.
"/software/packages"=pkg_repl("ncm-cdispd","13.1"+"-SNAPSHOT20130401212917","noarch");
